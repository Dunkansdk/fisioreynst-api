...
INSERT INTO tbl_users(id, email, password, username) VALUES (1, 'emanueldurso1@gmail.com', '$2a$10$8t9EBVzCBPziWWXQkBvXxeDlqXqVy2LFEIEZ5gxTxel1s8.X.l0Zy', 'emanuel') ON CONFLICT (id) DO NOTHING;
